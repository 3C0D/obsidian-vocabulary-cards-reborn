...
export default class VocabularyView extends Plugin {
	...
	async onload(): Promise<void> {
		...
		this.registerMarkdownCodeBlockProcessor(
			'voca-table',
			await this.renderTable.bind(this)
		);
		this.registerMarkdownCodeBlockProcessor(
			'voca-card',
			await this.parseCodeBlock.bind(this)
		);
	...
	async parseCodeBlock(
		...
		el.addEventListener('contextmenu', (e) =>
			handleContextMenu(e, this, el, ctx, source, cardStat, cardList, contentAfter)
		);
	...
	async renderTable(
		...
		el.addEventListener('contextmenu', (e) =>
			handleContextMenu(e, this, el, ctx, source)
		);
